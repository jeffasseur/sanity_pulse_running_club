        ...
        <div className="centered-nav__content">
          <div className="centered-nav__inner">
            ...
            <div data-navigation-item="" className="centered-nav__banner-w">
              <a href="#" className="centered-nav__banner">
